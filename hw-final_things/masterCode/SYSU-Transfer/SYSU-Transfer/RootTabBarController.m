...
- (void)viewDidLoad
{
    ...
    nc4.tabBarItem.selectedImage = [[UIImage imageNamed:@"local_s.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    nc4.tabBarItem.image = [[UIImage imageNamed:@"local.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    
    UINavigationController *nc5 = [[ChangedViewController alloc] init];
    nc5.tabBarItem.title = @"我的";
    nc5.tabBarItem.selectedImage = [UIImage imageNamed:@"wode-3.png"] ;
    nc5.tabBarItem.image = [UIImage imageNamed:@"wode-2.png"] ;
