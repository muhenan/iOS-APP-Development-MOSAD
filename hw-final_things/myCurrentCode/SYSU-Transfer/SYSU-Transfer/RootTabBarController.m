...
- (void)viewDidLoad
{
    ...
    UINavigationController *nc4 = [[ChangedViewController alloc] init];
    nc4.tabBarItem.title = @"我的";
    nc4.tabBarItem.selectedImage = [UIImage imageNamed:@"wode-3.png"] ;
    nc4.tabBarItem.image = [UIImage imageNamed:@"wode-2.png"] ;
