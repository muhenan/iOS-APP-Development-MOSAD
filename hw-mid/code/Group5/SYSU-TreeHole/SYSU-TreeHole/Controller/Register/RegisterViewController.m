...
@property(strong, nonatomic) NewTextField* email;
...
- (void)viewDidLoad {
    ...
    self.email = [[NewTextField alloc] initWithFrame:CGRectMake(110, 300, 250, 30)];
    ...
    [self.button setFrame:CGRectMake(280, 350, 80, 40)];
...
- (void)registerbuttonClicked{
    NSDictionary* data = @{@"name":self.username.text, @"email":self.email.text, @"password":self.password.text};
